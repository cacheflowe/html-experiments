...
Aggregator.prototype.init = function() {
  ...
  this.returned_ids = [];
  this.search_term = '"love+this+shit"+OR+lovethisshit+OR+"love+that+shit"';
...
Aggregator.prototype.tweetsLoaded = function(obj) {
  ...
  // draw tweets
	...
	$(obj.results).each(function(el){
	  ...
	  if(self.returned_ids.indexOf(this.id) == -1 && this.text.indexOf('http://') == -1 && this.text.indexOf('RT ') != 0) {

...
# concat css files
cat $compile_css_files > ./deploy/stylesheets/interface-min.css

# minify css
java -jar ./build/lib/yuicompressor-2.4.2.jar -v ./deploy/stylesheets/interface-min.css -o ./deploy/stylesheets/interface-min.css

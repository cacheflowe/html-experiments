...
_catchy.touchControl.init = function(){
  ...
  var _touchTracker = new tts.MouseAndTouchTracker( _catchy.screen.gameContainer, function( touchState ){
    switch( touchState ) {
      case tts.MouseAndTouchTracker.state_start :
        var newPercentX = (_touchTracker.touchcurrent.x - _catchy.screen.containerLeft) / _catchy.screen.width;
